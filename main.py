...
#        client.loop_start()
        ...
        client.publish("homeassistant/sensor/powercounter/ua/config", '{"availability":[{"topic":"power/status"}],"device":{"identifiers":["mercury230"],"manufacturer":"Mercury","model":"Mercury230","name":"Counter"},"device_class":"voltage","enabled_by_default":true,"json_attributes_topic":"power/counter","name":"Counter Ua","state_class":"measurement","state_topic":"power/counter","unique_id":"p_counter_ua","unit_of_measurement":"V","value_template":"{{ value_json.Ua }}"}', 1)
        client.publish("homeassistant/sensor/powercounter/ub/config", '{"availability":[{"topic":"power/status"}],"device":{"identifiers":["mercury230"],"manufacturer":"Mercury","model":"Mercury230","name":"Counter"},"device_class":"voltage","enabled_by_default":true,"json_attributes_topic":"power/counter","name":"Counter Ub","state_class":"measurement","state_topic":"power/counter","unique_id":"p_counter_ub","unit_of_measurement":"V","value_template":"{{ value_json.Ub }}"}', 1)
        client.publish("homeassistant/sensor/powercounter/uc/config", '{"availability":[{"topic":"power/status"}],"device":{"identifiers":["mercury230"],"manufacturer":"Mercury","model":"Mercury230","name":"Counter"},"device_class":"voltage","enabled_by_default":true,"json_attributes_topic":"power/counter","name":"Counter Uc","state_class":"measurement","state_topic":"power/counter","unique_id":"p_counter_uc","unit_of_measurement":"V","value_template":"{{ value_json.Uc }}"}', 1)
        client.publish("homeassistant/sensor/powercounter/ia/config", '{"availability":[{"topic":"power/status"}],"device":{"identifiers":["mercury230"],"manufacturer":"Mercury","model":"Mercury230","name":"Counter"},"device_class":"current","enabled_by_default":true,"json_attributes_topic":"power/counter","name":"Counter Ia","state_class":"measurement","state_topic":"power/counter","unique_id":"p_counter_ia","unit_of_measurement":"A","value_template":"{{ value_json.Ia }}"}', 1)
        client.publish("homeassistant/sensor/powercounter/ib/config", '{"availability":[{"topic":"power/status"}],"device":{"identifiers":["mercury230"],"manufacturer":"Mercury","model":"Mercury230","name":"Counter"},"device_class":"current","enabled_by_default":true,"json_attributes_topic":"power/counter","name":"Counter Ib","state_class":"measurement","state_topic":"power/counter","unique_id":"p_counter_ib","unit_of_measurement":"A","value_template":"{{ value_json.Ib }}"}', 1)
        client.publish("homeassistant/sensor/powercounter/ic/config", '{"availability":[{"topic":"power/status"}],"device":{"identifiers":["mercury230"],"manufacturer":"Mercury","model":"Mercury230","name":"Counter"},"device_class":"current","enabled_by_default":true,"json_attributes_topic":"power/counter","name":"Counter Ic","state_class":"measurement","state_topic":"power/counter","unique_id":"p_counter_ic","unit_of_measurement":"A","value_template":"{{ value_json.Ic }}"}', 1)
        client.publish("homeassistant/sensor/powercounter/pa/config", '{"availability":[{"topic":"power/status"}],"device":{"identifiers":["mercury230"],"manufacturer":"Mercury","model":"Mercury230","name":"Counter"},"device_class":"power","enabled_by_default":true,"json_attributes_topic":"power/counter","name":"Counter Pa","state_class":"measurement","state_topic":"power/counter","unique_id":"p_counter_pa","unit_of_measurement":"W","value_template":"{{ value_json.Pa }}"}', 1)
        ...
        client.publish("homeassistant/sensor/powercounter/pc/config", '{"availability":[{"topic":"power/status"}],"device":{"identifiers":["mercury230"],"manufacturer":"Mercury","model":"Mercury230","name":"Counter"},"device_class":"power","enabled_by_default":true,"json_attributes_topic":"power/counter","name":"Counter Pc","state_class":"measurement","state_topic":"power/counter","unique_id":"p_counter_pc","unit_of_measurement":"W","value_template":"{{ value_json.Pc }}"}', 1)
